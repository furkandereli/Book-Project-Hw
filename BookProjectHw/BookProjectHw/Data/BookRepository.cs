...
public class BookRepository : IBookRepository
{
    ...
    public BookRepository()
    {
        ...
        _bookData = new List<Book>()
        {
          ...
          new Book{Id=10,CategoryId="C", Description="Çok değerli bir kitap",Price=210, Stock=150, Title="Psikoloji1", Isbn = "abc123"}
        };
    }
    ...
    public Book GetByIsbn(string isbn)
    {
        ...
        try
        {
            book = _bookData.SingleOrDefault(x => x.Isbn == isbn);
